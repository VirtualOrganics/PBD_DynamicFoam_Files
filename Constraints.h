...
namespace PBD
{
	...
	public: 
		...
		// virtual bool updateConstraint(SimulationModel &model) { fprintf (stderr,"updateConstraint\n"); return true; };
		virtual bool updateConstraint(SimulationModel &model) { return true; };
		// virtual bool solvePositionConstraint(SimulationModel &model) { fprintf (stderr,"solvePositionConstraint\n"); return true; };
		virtual bool solvePositionConstraint(SimulationModel &model) { return true; };
		// virtual bool solveVelocityConstraint(SimulationModel &model) { fprintf (stderr,"solveVelocityConstraint\n"); return true; };
